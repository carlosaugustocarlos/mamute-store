<x-guest-layout>
    <div class="mb-6 text-center">
        <h1 class="text-2xl font-semibold text-slate-950">Redefinir palavra-passe</h1>
        <p class="mt-1 text-sm text-slate-500">Defina uma nova palavra-passe para a conta.</p>
    </div>
